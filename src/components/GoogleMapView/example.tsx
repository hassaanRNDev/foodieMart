...
//               <Switch onValueChange={setSignificantChanges} value={significantChanges} />
//             </View>
//           )}
...
//                 <Switch onValueChange={setLocationDialog} value={locationDialog} />
//               </View>
//               <View style={styles.option}>
//                 <Text>Force Location Request</Text>
//                 <Switch onValueChange={setForceLocation} value={forceLocation} />
//               </View>
//               <View style={styles.option}>
//                 <Text>Use Location Manager</Text>
//                 <Switch onValueChange={setUseLocationManager} value={useLocationManager} />
//               </View>
//               <View style={styles.option}>
//                 <Text>Enable Foreground Service</Text>
//                 <Switch onValueChange={setForegroundService} value={foregroundService} />
//               </View>
//             </>
//           )}
//         </View>
